...
const Loader = () => {
    return (
        <div className="h-dvh w-full flex flex-col items-center justify-center gap-4 bg-gradient-to-tr from-black via-indigo-950 to-fuchsia-950">
            <img
                src="/convo-logo.svg"
                alt="Convo Logo"
            ...
            <p className="text-gray-400 text-sm italic text-center tracking-wide">
                Patience is bitter,<br /> but its fruit is sweet. — Aristotle
            </p>
        </div>
    )
}
