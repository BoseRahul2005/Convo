    ...
    <>
      <div className="min-h-dvh w-full flex items-center justify-center bg-gradient-to-tr from-black via-indigo-950 to-fuchsia-950 relative p-4">
        ...
        <form
          ...
          noValidate // prevents default form submission which leads to page reload and clears all field values in the form
          className="w-full sm:w-87.5 max-w-sm text-center bg-white/6 border border-white/10 rounded-2xl px-6 sm:px-8 py-6"
        >
          <h1 className="text-white text-3xl mt-2 font-medium">Login</h1>
          ...
          <div className="mt-4 text-left">
            <button
              ...
              className="cursor-pointer text-sm text-indigo-400 hover:underline"
            >
              Forget password?
            </button>
          </div>
          ...
          <button
            ...
            className="mt-2 w-full h-11 rounded-full text-white bg-indigo-600 hover:bg-indigo-500 transition disabled:opacity-50 cursor-pointer"
          >
            {isSubmitting ? (
